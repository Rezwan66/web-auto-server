...
# from app.utils.old_ollama_client import generate_llm_response, generate_with_ollama
...
def sampleGenFunc(prompt: str, metadata: dict) -> dict:
...
async def generate(request: LLMRequest):
    ...
    try:
        result = sampleGenFunc(request.prompt, metadata)
